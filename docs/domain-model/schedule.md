...
A schedule represents a structured collection of time slots managed by an organization.
...
* A schedule is displayed using the organization timezone by default.
